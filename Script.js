...
// getcontent.classList = "divcontent";

// const carts = async () => {
//   try {
//     const res = await getclick();
//     let hed = document.querySelector("header");

//     let creatselect = document.createElement("select");

//     let op = document.createElement("option");
//     op.disabled = " disabled ";
//     op.innerHTML = "Choose";
//     creatselect.append(op);
//     creatselect.id = "creatselect";
...
//       creatimg.classList = "img";
//       let creatp = document.createElement("p");
//       let creatoption = document.createElement("option");
//       creatoption.classList = "creatoption";
//       creatoption.innerHTML = `${index.name}-S0${index.season}E0${index.number}`;
//       if (index.number > 9) {
//         creatoption.innerHTML = `${index.name}-S0${index.season}E${index.number}`;
//       }
//       creatselect.append(creatoption);
//       hed.append(creatselect);
//       creatdiv.classList = "creatdiv";
//       creatimg.classList = "creatimg";
//       creath2.classList = "creath2";
//       creatoption.id = "creatoption";
//       creatp.classList = "creatp";
//       creath2.innerHTML = `${index.name}-S0${index.season}E0${index.number}`;
//       if (index.number > 9) {
//         creath2.innerHTML = `${index.name}-S0${index.season}E${index.number}`;
//       }
//       creatimg.src = index.image.medium;
//       link.href = `${index.url}`;
//       creatp.innerHTML = index.summary;

//       getcontent.append(creatdiv);
//       creatdiv.append(creath2);
//       creatdiv.append(creatimg);
//       creatdiv.append(creatp);
//       link.append(creatdiv);
//       getcontent.append(link);
//     }

//     creatselect.addEventListener("change", function (e) {
//       let divs = document.getElementsByClassName("creatdiv");
//       let b = document.getElementsByClassName("creath2");
//       let sele = creatselect.options[creatselect.selectedIndex].text;
//       // console.log(sele);
//       for (let index = 0; index < creatselect.length; index++) {
//         // console.log(b[index].innerHTML);
//         if (creatoption[index].value === sele) {
...
//     btn.innerText = "Getting trouble? Click ME!";
...
//   let classdiv = document.getElementsByClassName("creatdiv");
//   let num = divs.length;
//   let t = 0;
//   // console.log(num);
//   for (i = 0; i < classdiv.length; i++) {
//     if (!classdiv[i].innerHTML.toLowerCase().includes(input)) {
...
//     // }
//     // num--;
//     label.innerHTML = `Displaying ${num / 2}/${divs.length} Episodes`;
//   }
// });
// carts();
...
const carts = () => {
  try {
    ...
    creatselect.className = "classselect";
    for (const index of res) {
      ...
      creatp.innerHTML = `${index.summary}`;
      creatoption.innerHTML = `${index.name}-S0${index.season}E0${index.number}`;
      creata.href = `${index.url}`;
      if (index.number > 9) {
        creath2.innerHTML = `${index.name}-S0${index.season}E${index.number}`;
        creatoption.innerHTML = `${index.name}-S0${index.season}E${index.number}`;
      }
      creatdiv.className = "creatdiv";
      creatimg.className = "creatimg";
      creath2.className = "creath2";
      creatoption.className = "classoption";
      creatselect.append(creatoption);
      header.append(creatselect);
      creata.append(creatdiv);
      creatdiv.append(creath2);
      creatdiv.append(creatimg);
      creatdiv.append(creatp);
      divcontent.append(creata);
    }
  } catch (e) {
    console.log("ERROR!", e);
  }
...
input.addEventListener("keyup", function () {
  ...
  for (let index = 0; index < divs.length; index++) {
    ...
    if (!divs[index].innerHTML.toLowerCase().includes(input)) {
  ...
  label.innerHTML = `Displaying ${num}/${divs.length} Episodes`;
});

let select = document.querySelector(".classselect");
select.addEventListener("change", function (e) {
  let divs = document.getElementsByClassName("creatdiv");
  let option = document.getElementsByClassName("classoption");
  let selects = select.options[select.selectedIndex].text;
  // console.log(selects);
  for (let index = 0; index < select.length; index++) {
    if (option[index].value === selects) {
      divs[index].style.display = "block";
    } else {
      divs[index].style.display = "none";
    }
...
let btn = document.createElement("button");
btn.innerHTML = "Getting trouble? Click ME!";
btn.addEventListener("click", function () {
  let divs = document.getElementsByClassName("creatdiv");
  for (let index = 0; index < divs.length; index++) {
    divs[index].style.display = "block";
